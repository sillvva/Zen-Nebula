...
<div align="center">
  <img height="500" src="https://i.ibb.co/ZRFXDBW2/Screenshot-2025-03-06-195221.png"  />
</div>
...
<p align="left">• If you have not already, follow the Zen Live Editing guide to first create your chrome folder: https://docs.zen-browser.app/guides/live-editing<br><br>• Download the ZIP file from latest Release version and paste the Nebula folder inside the chrome folder and open your userChrome.css and add the line "@import "Nebula/Nebula.css";" OR if you dont want to add this line to your userChrome then take the userChrome.css file provided in the ZIP file and directly paste that one into your chrome folder.<br><br>• Restart the browser to see if the UI has changed.<br><br>• Go to about:config in Zen and search for "browser.tabs.allow_transparent_browser". If the option is visible, set it to "true". If not, click the "+" icon and set it to "boolean".<br><br>• Install the wallpapers (optional)</p>
